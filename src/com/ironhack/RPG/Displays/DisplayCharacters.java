...
public class DisplayCharacters {
    ...
    //ARRAY_LIST
    public static final ArrayList<String> WIZARD = new ArrayList<>(List.of(Colors.WIZARD + "\t\t\t\t                    ____\t\t\t\t",
            Colors.WIZARD + "\t\t\t\t                  .'* *.'\t\t\t\t",
            Colors.WIZARD + "\t\t\t\t               __/_*_*(_\t\t\t\t",
            Colors.WIZARD + "\t\t\t\t              / _______ \\\t\t\t\t",
            Colors.WIZARD + "\t\t\t\t             _\\_)/___\\(_/_\t\t\t\t",
            Colors.WIZARD + "\t\t\t\t            / _((\\- -/))_ \\\t\t\t\t",
            Colors.WIZARD + "\t\t\t\t             \\ \\())(-)(()/ /\t\t\t\t",
            Colors.WIZARD + "\t\t\t\t             ' \\(((()))/ '\t\t\t\t",
            Colors.WIZARD + "\t\t\t\t            / ' \\)).))/ ' \\\t\t\t\t",
            ...
            Colors.WIZARD + "\t\t\t\t           /   /   |   \\   \\\t\t\t\t",
            Colors.WIZARD + "\t\t\t\t         .'   /    b    '.  '.\t\t\t\t",
            Colors.WIZARD + "\t\t\t\t     _.-'    /     Bb     '-. '-._\t\t\t",
            Colors.WIZARD + "\t\t\t\t _.-'       |      BBb       '-.  '-.\t\t\t",
            Colors.WIZARD + "\t\t\t\t(________mrf\\____.dBBBb.________)____)\t\t\t"));

    public static final ArrayList<String> WARRIOR = new ArrayList<>(List.of(Colors.WARRIOR + "\t\t\t                                   Y\t\t\t\t\t",
            Colors.WARRIOR + "\t\t\t                                  _A_\t\t\t\t\t",
            Colors.WARRIOR + "\t\t\t                                 / | \\\t\t\t\t\t",
            Colors.WARRIOR + "\t\t\t                                |.-=-.|\t\t\t\t\t",
            Colors.WARRIOR + "\t\t\t                                )\\_|_/(\t\t\t\t\t",
            Colors.WARRIOR + "\t\t\t                             .=='\\   /`==.\t\t\t\t",
            Colors.WARRIOR + "\t\t\t                           .'\\   (`:')   /`.\t\t\t\t",
            Colors.WARRIOR + "\t\t\t                         _/_ |_.-' : `-._|__\\_\t\t\t\t",
            Colors.WARRIOR + "\t\t\t                        <___>'\\    :    /`<___>\t\t\t\t",
            Colors.WARRIOR + "\t\t\t                        /  /   >=======<  /  /\t\t\t\t",
            Colors.WARRIOR + "\t\t\t                      _/ .'   /  ,-:-.  \\/=,'\t\t\t\t",
            Colors.WARRIOR + "\t\t\t                     / _/    |__/v^v^v\\__) \\\t\t\t\t",
            Colors.WARRIOR + "\t\t\t                     \\(\\)     |V^V^V^V^V|\\_/\t\t\t\t",
            Colors.WARRIOR + "\t\t\t                      (\\\\     \\`---|---'/\t\t\t\t",
            Colors.WARRIOR + "\t\t\t                        \\\\     \\-._|_,-/\t\t\t\t",
            Colors.WARRIOR + "\t\t\t                         \\\\     |__|__|\t\t\t\t\t",
            Colors.WARRIOR + "\t\t\t                          \\\\   <___X___>\t\t\t\t",
            Colors.WARRIOR + "\t\t\t                           \\\\   \\..|../\t\t\t\t\t",
            Colors.WARRIOR + "\t\t\t                            \\\\   \\ | /\t\t\t\t\t",
            Colors.WARRIOR + "\t\t\t                             \\\\  /V|V\\\t\t\t\t\t",
            Colors.WARRIOR + "\t\t\t                              \\|/  |  \\\t\t\t\t\t",
